...
const OrderTrackingDashboard = () => {
  ...
  // Данные регионов
  const regionData = [
    { id: 'region1', name: 'Ташкент', value: 235873, change: 18.5, color: '#4747e5' },
    { id: 'region2', name: 'Самарканд', value: 124356, change: 12.3, color: '#60a5fa' },
    { id: 'region3', name: 'Бухара', value: 89745, change: -5.7, color: '#34d399' },
    { id: 'region4', name: 'Наманган', value: 67890, change: 9.2, color: '#f59e0b' },
    { id: 'region5', name: 'Андижан', value: 56780, change: -3.4, color: '#ec4899' },
    { id: 'region6', name: 'Нукус', value: 45670, change: 15.8, color: '#8b5cf6' }
  ];

  // Данные моделей по регионам (для детализации)
  const modelsByRegion = {
    'region1': [
      { id: 'model1_r1', name: 'Лачетти', category: 'Седан', value: 23456, change: 15.7, icon: '🚗', color: '#4747e5' },
      { id: 'model2_r1', name: 'Нексия 3', category: 'Седан', value: 18765, change: -10.2, icon: '🚗', color: '#60a5fa' },
      { id: 'model3_r1', name: 'Кобальт', category: 'Седан', value: 21345, change: 25.6, icon: '🚗', color: '#34d399' },
      { id: 'model4_r1', name: 'Дамас', category: 'Минивэн', value: 28760, change: -15.3, icon: '🚐', color: '#f59e0b' },
    ],
    'region2': [
      { id: 'model1_r2', name: 'Лачетти', category: 'Седан', value: 18532, change: 21.4, icon: '🚗', color: '#4747e5' },
      { id: 'model3_r2', name: 'Кобальт', category: 'Седан', value: 16895, change: 14.2, icon: '🚗', color: '#34d399' },
      { id: 'model5_r2', name: 'Спарк', category: 'Хэтчбек', value: 15432, change: -8.7, icon: '🚙', color: '#ec4899' },
    ],
  ...
  const renderModelsChart = () => {
    ...
    if (currentView === 'model' && selectedModel) {
      ...
      const specs = [
        { label: 'Категория', value: selectedModel.category },
      ...
      {currentView === 'model' && (
        <div className="lg:col-span-8 bg-gradient-to-br from-slate-800 to-slate-900 p-6 rounded-2xl shadow-xl border border-slate-700/50 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="bg-slate-800/30 rounded-xl border border-slate-700/30 p-4 mb-4 h-56 flex items-center justify-center">
