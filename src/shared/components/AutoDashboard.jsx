...
const response = await axiosInstance.post('https://uzavtoanalytics.uz/dashboard/proxy', {
 ...
 const renderChart = () => {
   ...
   const mainColor = marketType === 'all' ? "#8b5cf6" : 
   ...
   <div className={`${isDark ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'} p-4 md:p-6`} ref={containerRef}>
     ...
     <div className="mb-6">
       <h1 className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-gray-900'} flex items-center`}>
         <CarFront className="mr-2 text-purple-500" size={28} />
       ...
       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
         ...
         <motion.div 
           ...
           className={`bg-gradient-to-br ${isDark ? 'from-gray-800 to-gray-900' : 'from-white to-gray-50'} p-5 rounded-lg border ${isDark ? 'border-gray-700' : 'border-gray-200'} shadow-md transition-all duration-300 cursor-pointer ${
             marketType === 'all' ? 'ring-2 ring-purple-500/50' : ''
           }`}
           onClick={() => handleMarketTypeChange('all')}
         >
           <div className="flex justify-between items-center">
             ...
             <div className={`w-14 h-14 rounded-xl ${isDark ? 'bg-gradient-to-br from-purple-500/20 to-purple-600/10' : 'bg-gradient-to-br from-purple-500/10 to-purple-600/5'} flex items-center justify-center text-purple-500 shadow-lg`}>
                     ...
                     >
                       ...
                       <td className="px-4 py-4 whitespace-nowrap">
                         ...
                         <div className={`w-full ${isDark ? 'bg-gray-700' : 'bg-gray-200'} rounded-full h-1.5 mt-2 overflow-hidden`}>
                           <div 
                             className={`h-1.5 rounded-full ${i === 0 ? 'bg-gradient-to-r from-purple-500 to-purple-600' : 'bg-gradient-to-r from-gray-500 to-gray-600'}`}
                             style={{
